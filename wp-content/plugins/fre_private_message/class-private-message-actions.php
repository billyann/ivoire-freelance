...
class AE_Private_Message_Actions extends AE_PostAction
{
    ...
    function fetch_post() {
        ...
        if(isset($query['post_parent'])){
            ...
            $project_link = sprintf(__('Project %s', ET_DOMAIN), $project_title );
        }
    ...
    public function ae_private_message_notify_item( $content, $notify ){
        ...
        if($type == 'new_private_message'){
            ...
            $message_link = et_get_page_link('profile').'?pr_msg_c_id='. $private_message_id.'#tab_private_msg';
            $message_link = '<a href="' . $message_link . '" >' . $private_message . '</a>';

...
if( !function_exists('fre_credit_add_profile_tab_content') ){
    ...
    function fre_credit_add_profile_tab_content(){
        ...
        <div class="tab-pane fade tabs-credits" id="credits">
            ...
            <!-- Infomation Account Credit-->
            <div class="changelog balance">
                <div class="bar-title padding-title">
                    <p class="title"><?php _e('Your Balance', ET_DOMAIN ); ?></p>
                </div>
                <div class="balance-credit">
                    <span class="available"><?php _e('Credit balance', ET_DOMAIN) ?></span>
                    <span class="text-blue-light buget fre_credit_total_text"><?php echo fre_price_format($total->balance) ?></span>
                </div>
                <div class="row info-balance">
                    <div class="balance-available col-md-6 col-xs-6">
                    ...
                    <div class="balance-frozen col-md-6 col-xs-6">
                ...
                <div class="button-functions <?php echo ((float)$minimum > $available->balance) ? 'not-money': ''; ?>">
                    <button class="btn-sumary btn-add blue-light box-shadow-button-blue" onClick="window.location.href='<?php echo fre_credit_deposit_page_link() ?>'"> <?php _e('Recharge', ET_DOMAIN); ?></button>
                    <?php if((float)$minimum > $available->balance):?>
                    <button class="btn-sumary btn-withdraw green-dark box-shadow-button-green btn-not-money"
                            data-toggle="modal" data-toggle="popover" data-content="<?php printf(__('Unable to withdraw money. Your available credit must be greater or equal to %s', ET_DOMAIN), ae_get_option('fre_credit_minimum_withdraw', 50)); ?>"
                            data-target="#">
                    <?php else: ?>
                    <button class="btn-sumary btn-withdraw green-dark box-shadow-button-green btn-withdraw-action"
                            data-toggle="modal"
                            data-target="#">
                    <?php endif;?>
            ...
            <div class="changelog fre-credit-history-wrapper">
                <div class="bar-title">
                    <p class="title padding-title"><?php _e('Credits changelog', ET_DOMAIN ); ?></p>
                </div>
                <div class="function-filter">
                    <div class="value">
                        ...
                        <ul class="list-value hide fre-credit-history-filter">
                            ...
                            <li><a href="#" class="text-orange-light" data-value="refund" data-name="<?php _e('Refund', ET_DOMAIN); ?>"><?php _e('Refund', ET_DOMAIN); ?></a></li>
                        </ul>
                    </div>
                    <div class="date">

...
<li class="bid-item">
        ...
        ?>
                    ...
                    <ul class="info-history action-project">
                        ...
                        <li class="date"><?php _e('Start date:', ET_DOMAIN); 
                                echo $current->project_post_date;?></li>
                    </ul>
        <?php   break;
                // DISPUTING
                case 'disputing':
        ?>
                    ...
                    <ul class="info-history action-project">
                        ...
                        <?php if(!$wp_query->query['is_author']) { ?>
                            <li><a href="<?php echo $current->project_link; ?>" class="btn btn-apply-project-item"><?php _e('Dispute Page', ET_DOMAIN);?></a></li>
                        <?php } ?>
                    </ul>
        <?php   break;
                // RESOLVED

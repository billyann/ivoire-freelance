...
<div class="info-project-items-employer">
    ...
    <?php
        ...
        if(have_posts()):
            ...
            echo '<ul style="list-style:none;padding:0;"><li><div class="no-results">'.__('<p>You have not created any projects yet.</p><p>It is time to start creating ones.</p>', ET_DOMAIN).'<div class="add-project"><a href="'.$link_submitProject.'" class="btn-submit-project">'.__('Post a project', ET_DOMAIN).'</a></div></div></li></ul>';
        endif;
        //wp_reset_postdata();
     ?>

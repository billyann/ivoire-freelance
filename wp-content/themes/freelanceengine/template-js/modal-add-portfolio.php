			...
			<div class="modal-body">
				<form role="form" id="create_portfolio" class="auth-form create_portfolio">
                	...
                	<div class="form-group portfolio-skills">
                		...
                		<p>
	                		<select id="skills" name="skill" data-placeholder="<?php _e('Select an option', ET_DOMAIN); ?>">
                	...
                	<div class="clearfix"></div>
					<button type="submit" class="btn-submit btn-sumary btn-sub-create btn-add-portfolio">

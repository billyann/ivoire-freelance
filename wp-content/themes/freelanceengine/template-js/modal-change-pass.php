			...
			<div class="modal-body">
				<form role="form" id="chane_pass_form" class="auth-form chane_pass_form">
					<div class="form-group">
						<label for="old_password"><?php _e('Current Password', ET_DOMAIN) ?></label>
						<input type="password" class="form-control" id="old_password" name="old_password" placeholder="<?php _e('Enter your current password', ET_DOMAIN) ?>">
					</div>

...
<section id="blog-page">
	<div class="container">
    	<div class="row" id="post-project">

        	<!-- Column left -->
        	<div class="col-md-8 col-sm-12 col-xs-12">
            	<div class="post-place-wrapper" id="post-place">
                    ...
                    ?>
                    <input type="hidden" name="is_submit_project" value="1" />
                </div>
                ...
                */
                ...
                if($tos) { ?>
                    ...
                    <?php
                        printf(__('By posting your project, you agree to our <a href="%s" target="_Blank" rel="noopener noreferrer">Term of Use and Privacy policy</a>', ET_DOMAIN), et_get_page_link('tos') );
                    ?>
                    </div>
                <?php } ?>
            <!-- Column left / End -->

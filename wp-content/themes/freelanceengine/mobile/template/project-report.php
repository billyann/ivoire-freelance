...
<div class="workplace-container project-workplace-details report-details">
    <div class="project-workplace-report-line"></div>
    <div class="content-require-project-report">
        <div class="workplace-title-wrap">
            <div id="workplace-title-report" class="workplace-title">
                <h4><?php _e('Report',ET_DOMAIN);?></h4>
                <div class="workplace-title-arrow"><span></span></div>
            </div>
        </div>
        <div class="project-workplace-report">
                    ...
                    <form class="form-group-work-place-wrapper form-report notify-mail">
                        <div class="form-group-work-place work-place-dispute" id="report_docs_container">
                            ...
                            <div class="content-report-wrapper">
                                <div class="">
                                    <textarea name="comment_content" class="content-chat" required placeholder="<?php _e( "Type your report here" , ET_DOMAIN ); ?>"></textarea>
                                </div>
                            ...
                            <div class="file-attachment-wrapper">
                                <!-- report file list -->
                                <ul class="file-attack-report apply_docs_file_list" id="apply_docs_file_list"></ul>
                            </div>
                            <!--button send mobile-->
                            <div class="button-send-report">
                                    <input type="submit" name="submit" value="<?php _e( "SEND" , ET_DOMAIN ); ?>" class="btn btn-agree submit-chat-content">
                            </div>
                        </div>
                    </form>
                <?php } ?>
            ...
            <div class="project-report-quit">
                ...
                <?php 
                    if(fre_access_workspace($post)){
                        ...
                        echo '<a class="workspace-links" href="'.add_query_arg(array('workspace' => 1), $project_link).'">'
                            .__("Open workspace >", ET_DOMAIN).'
                        </a>';
                    }
                 ?>
            </div>
            ...
            <div class="project-report-arbitrate">
                ...
                <?php
                    if(fre_access_workspace($post)){
                        ...
                        echo '<a class="workspace-links" href="'.add_query_arg(array('workspace' => 1), $project_link).'">'.__("Open workspace >", ET_DOMAIN).'</a>';
                    }
                ?>
            </div>
        <?php } ?>

...
if(isset($_REQUEST['workspace']) && $_REQUEST['workspace']) {
    echo '<div class="in-workspace"><a href="'.get_permalink( $post->ID ).'">&lt; '.__("Back to project detail", ET_DOMAIN).'</a></div>';
}else {
    echo '<div class="in-workspace"><a class="workspace-link" style="font-weight:600;" href='.add_query_arg(array('workspace' => 1), $project_link ).'>'.__("Open Workspace ", ET_DOMAIN).'</a></div>';
}
?>
<div class="workplace-details">
    <div class="content-require-project-conversation">  
        <div class="workplace-title-wrap">
            <div id="workplace-title-conversation" class="workplace-title">
                <h4><?php _e('Conversation',ET_DOMAIN);?></h4>
                <div class="workplace-title-arrow">
                    <span></span>
                </div>
            </div>  
        </div>
        <div class="workplace-project-conversation message-container">
                    ...
                    <div class="form-group-work-place">
                        ...
                        <div class="content-chat-wrapper form-content-chat-wrapper">
                            ...
                            <div class="submit-btn-msg">
                                <span class="submit-icon-msg disabled"><input type="submit" name="submit" value="" class="submit-chat-content disabled" disabled></span>
                            </div>
    ...
    <div class="content-require-project content-require-project-attack">
        <div class="workplace-title-wrap">
            <div class="workplace-title">
                ...
                <div class="workplace-title-arrow file-container" id="file-container">
                    <div id="apply_docs_container">
                        ...
                        <a href="#" class="attack attach-file" id="apply_docs_browse_button"><i class="fa fa-plus"></i><?php _e('Upload file ',ET_DOMAIN);?></a>
                    </div>
                    <span></span>
                </div>
                <?php } ?>
                ...
                <?php
                    ...
                    foreach ($attachments as $key => $value) {
                        ...
                        if($post->post_status == 'close' && $value->post_author == $user_ID && !$value->post_parent){
                            $html_removeAtt = '<a href="#" data-id="'.$value->ID.'" data-project="'.$post->ID .'" data-filename="'.$value->post_title.'" class="removeAtt"><i class="fa fa-times pull-right" aria-hidden="true"></i></a>';
                        }else{
                            $html_removeAtt = '';
                        }
                ?>

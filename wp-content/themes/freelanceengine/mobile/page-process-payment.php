...
?>
	<div class="container">
		...
		<div class="row block-posts" id="post-control">
			...
			<div class="col-md-12 col-xs-12 payment-content-payment">
								...
								if(isset($order_data['products'])){
									...
									switch ($type) {
										case 'bid_plan':
											...
											echo "<a href='".$permalink."'>".__('Return', ET_DOMAIN)."</a>";
											break;

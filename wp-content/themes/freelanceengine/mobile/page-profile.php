                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-mobile-wrapper form-user-profile" id="profile_form">
                            ...
                            <div class="form-group-mobile">
                                ...
                                <!-- <a href="#" class="icon-edit-profile-user edit-info-user"><i class="fa fa-pencil"></i></a> -->
                                <div class="group_profile_tan">
                                    <input min="0" type="number" name="et_experience" value="<?php echo $experience; ?>" class="required numberVal number"/>
    	...
    	<form class="form-mobile-wrapper form-user-profile">
            <div class="form-group-mobile edit-profile-title user-profile-history info-project-items">
                ...
                <div class="list-user-bids" id="list-user-bid-wrapper">
                    <!-- BIDDING -->
                    <label>
                        <?php _e("Your Current Bids", ET_DOMAIN) ?>
                    </label>
                    <?php 
                        global $wp_query;
                    ...
                    <div class="filter">
                        <div class="filter-project" >
                            <label for="">
                                <select class="status-filter" name="filter_bid_status"
                ...
                <?php //if(!empty($user_bids)): ?>
                    <div class="list-bid-history" id="list-bid-history-wrapper">
                        <!-- Work History of freelance-->
                        <label>
                            <?php _e('Your Work History and Reviews', ET_DOMAIN) ?>
                        </label>
                        <?php
                            add_filter('posts_orderby', 'fre_reset_order_by_project_status');
                            add_filter('posts_where', 'fre_filter_where_bid');
                            $work_project = query_posts( array(
                                        'post_status' => array('accept', 'complete'),
                                        'post_type' => BID,
                                        'author' => $current_user->ID,
                                        'accepted' => 1,
                                        'filter_work_history' => '',
                        ...
                        <div class="filter">
                            <div class="filter-project" >
                                <label for="">
                                    <select class="status-filter" name="filter_work_history"
                                            data-placeholder="<?php _e("View All", ET_DOMAIN); ?>">
                                        <option value=""><?php _e("View All", ET_DOMAIN); ?></option>
                                        <option value="complete"><?php _e("Completed", ET_DOMAIN); ?></option>
                                        <option value="disputing"><?php _e("Disputed", ET_DOMAIN); ?></option>
                                        <option value="unadisputedccept"><?php _e("Resolved", ET_DOMAIN); ?></option>
                                    </select>
                                </label>
                            </div>
                        </div>
                ...
                <?php //endif;?>
                <?php } else { ?>
                <div class="list-bid-history-employer" id="list-bid-history-wrapper">
                    <?php get_template_part('mobile/template/work', 'history');?>
                </div>
                <?php } ?>
                <!-- / END BIDDING -->
            </div>

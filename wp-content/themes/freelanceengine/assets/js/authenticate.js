                    ...
                    success: function(user, status, jqXHR) {
                        ...
                        if (status.success) {
                            ...
                            if(ae_globals.gg_captcha == '1' && ae_globals.is_submit_project == '1'){
                                $('#step-post .gg-captcha').html('');
                                $('#step-post .gg-captcha').append('<input type="hidden" class="input-item form-control text-field" name="captcha_complete" value="1" />');
                            }
                        } else {
                            AE.pubsub.trigger('ae:notification', {
                                msg: status.msg,
                        ...
                        if (status.success) {
                            ...
                            if(ae_globals.gg_captcha == '1' && ae_globals.is_submit_project == '1'){
                                if($('.signup_form_submit .container_captcha .gg-captcha').length > 0){
                                   var captchaHTML = $('.signup_form_submit .container_captcha .gg-captcha').appendTo('#step-post .container_captcha');
                                   // reset Recaptcha
                                   grecaptcha.reset();
                                }
                            }

            ...
            getInformation: function(){
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if(res.data.success){
                            view.$el.find('.transfer-money-form .form-group').html(view.template(res.data));
                        }
                    ...
                    success: function(res) {
                        ...
                        if (res.success) {
                            ...
                            if(typeof fre_credit_globals != 'undefined' && fre_credit_globals.is_credit_escrow == 1){
                                ...
                                if(parseFloat(res.data.data_not_format.total) < parseFloat(fre_credit_globals.available_of_user)){
                                    res.data['accept_bid'] = 1;
                                }else{
                            ...
                            if(typeof fre_credit_globals != 'undefined' && fre_credit_globals.is_credit_escrow == 1){
                                ...
                                if(parseFloat(res.data.data_not_format.total) < parseFloat(fre_credit_globals.available_of_user)){
                                    ...
                                    var url_deposit = fre_credit_globals.url_deposit + '?project_id=' + project_data.ID;
                                    view.$el.find('.escrow-info').find('.btn-buy-credit').attr('href', url_deposit);
                                    view.$el.find('.notice_credit').html(fre_credit_globals.text_acceptance_bid.fail);
                                }
                            }
                        }else{
                            AE.pubsub.trigger('ae:notification', {

...
function ae_edit_post_button ($post) {
	if($post->post_status == 'pending'){ ?>
        <a title="<?php _e("Edit", ET_DOMAIN); ?>" data-action="edit" data-target="#" class="action edit" href="#edit_place"><i class="fa fa-pencil"></i><?php _e("Edit", ET_DOMAIN); ?></a>
    <?php } ?>
...
?>
	<# if(post_status == 'pending'){ #>
        <a data-action="edit" data-target="#" class="action edit" href="#edit_place" title="<?php _e('Edit', ET_DOMAIN);?>"><i class="fa fa-pencil"></i><?php _e('Edit', ET_DOMAIN);?></a>
    <# } #>
    ...
    <# if(post_status == 'reject'){ #>
    	<a data-action="edit" data-target="#" class="action edit" title="<?php _e('Edit', ET_DOMAIN);?>" href="#edit_place"><i class="fa fa-pencil"></i><?php _e('Edit', ET_DOMAIN);?></a>
    <# } #>

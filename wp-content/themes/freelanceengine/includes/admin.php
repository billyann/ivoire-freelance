        ...
        <div class="et-main-content" id="overview_settings">
            <div class="et-main-right">
                <div class="et-main-main clearfix inner-content" id="wizard-sample">
                    ...
                    <div class="desc" style="padding-top:0px;">
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit.php?post_type=project' ); ?>" ><?php _e('Project',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new project types or modify the sample ones to suit your site style.',ET_DOMAIN) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit-tags.php?taxonomy=project_category&post_type=project' ); ?>" ><?php _e('Project Categories',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new categories or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit-tags.php?taxonomy=project_type&post_type=project' ); ?>" ><?php _e('Project Type',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new project type or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit-tags.php?taxonomy=skill&post_type=project' ); ?>" ><?php _e('Skill',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new skill or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit.php?post_type=fre_profile' ); ?>" ><?php _e('Profile',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new profile types or modify the sample ones to suit your site style.',ET_DOMAIN) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit.php?post_type=page' ); ?>" ><?php _e('Pages',ET_DOMAIN) ?></a> <span class="description"><?php _e('Modify the sample "About us, Contact us, ..." pages or add your extra pages when needed.',ET_DOMAIN) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" rel="noopener noreferrer" href="<?php echo admin_url( 'edit.php' ); ?>" ><?php _e('Posts',ET_DOMAIN) ?></a> <span class="description"><?php _e('A couple of news & event posts have been added for your review. You can delete it or add your own posts here.',ET_DOMAIN) ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="et-main-main clearfix inner-content <?php if (!$sample_data_op) echo 'hide'; ?>" id="overview-listplaces">
                    ...
                    <div class="title font-quicksand  sample-title">
                        <a target="_blank" rel="noopener noreferrer" href="admin.php?page=et-settings" ><?php _e('General Settings',ET_DOMAIN) ?></a> <span class="description"><?php _e('Modify your site information, social links, analytics script, or add a language, etc.',ET_DOMAIN) ?></span>
                    </div>

                    <div class="title font-quicksand sample-title">
                        <a target="_blank" rel="noopener noreferrer" href="edit.php?post_type=page" ><?php _e('Front Page',ET_DOMAIN) ?></a> <span class="description"><?php _e('Rearrange content elements or add more information in your front page to suit your needs.',ET_DOMAIN) ?></span>
                    </div>

                    <div class="title font-quicksand sample-title">
                        <a target="_blank" rel="noopener noreferrer" href="nav-menus.php" ><?php _e('Menus',ET_DOMAIN) ?></a> <span class="description"><?php _e('Edit all available menus in your site here.',ET_DOMAIN) ?></span>
                    </div>

                    <div class="title font-quicksand sample-title">
                        <a href="widgets.php" target="_blank" rel="noopener noreferrer"><?php _e('Sidebars & Widgets',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add or remove widgets in sidebars throughout the site to best suit your need.',ET_DOMAIN) ?></span>
                    </div>
    ...
    function admin_setup() {
        ...
        $sections['content'] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("Select Skill From A Predefined List", ET_DOMAIN) ,
                        'id' => 'switch-skill',
                        'class' => '',
                ...
                array(
                    'args' => array(
                        'title' => __("Select Country From A Predefined List", ET_DOMAIN) ,
                        'id' => 'switch-country',
                        'class' => '',
                        'desc' => __("Users Choose Country From A Drop-Down List Instead Of Entering Country Data.", ET_DOMAIN)
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            'id' => 'switch_country',
                            'type' => 'switch',
                            'title' => __("Switch Country", ET_DOMAIN) ,
                            'name' => 'switch_country',
                            'class' => 'option-item bg-grey-input ',
                            'label_1' => __("Yes", ET_DOMAIN) ,
                            'label_2' => __("No", ET_DOMAIN) ,
            ...
            'groups' => array(
                array(
                    'args' => array(
                        ...
                        'id'    => 'google-recaptcha',
                        'class' => '',
                        'desc'  => __("Enabling this will prevent spammers from registering.<a href='https://www.google.com/recaptcha/admin#list' target='_blank' rel='nofollow noopener noreferrer' >get key</a>", ET_DOMAIN)
                    ),
                    'fields' => array(
                        array(
                            'id'    => 'gg_captcha',

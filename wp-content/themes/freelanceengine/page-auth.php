			                            ...
			                            <p class="text-term">
							                ...
							                */
							                ...
							                if(!get_theme_mod( 'termofuse_checkbox', false ) && $tos) { ?>
							                    <?php
							                        printf(__('By creating an account, you agree to our <a href="%s" target="_Blank" rel="noopener noreferrer">Term of Use and Privacy policy</a>', ET_DOMAIN), et_get_page_link('tos') );
							                    ?>
							                <?php } ?>
										</p>
			                             <?php
